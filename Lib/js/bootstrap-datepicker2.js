...
!function( $ ) {
    ...
    var Datepicker = function(element, options) {
        ...
        if (this.isRTL){
            ...
            this.picker.find('.prev i, .next i') 
                .toggleClass('glyphicon glyphicon-circle-arrow-left, glyphicon glyphicon-circle-arrow-right'); 
        }
    ...
    var DPGlobal = {
        ...
        headTemplate: '<thead>'+
            '<tr>'+
            '<th class="prev"><i class="glyphicon glyphicon-circle-arrow-left"/></th>'+
            '<th colspan="5" class="datepicker-switch"></th>'+
            '<th class="next"><i class="glyphicon glyphicon-circle-arrow-right"/></th>'+
            '</tr>'+
            '</thead>',
